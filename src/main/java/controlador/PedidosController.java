...
public class PedidosController extends HttpServlet{
	...
	private void listar(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
		...
		req.getRequestDispatcher("jsp/GestionarEstadoDelPedido.jsp").forward(req, resp);
	}
	
	private void seleccionarPedido(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	...
	private void seleccionarPlato(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException{
		// 1.- Obtener los parámetros
		// 2.- Hablar con el modelo
		// 3.- Llamar a la vista
	}
