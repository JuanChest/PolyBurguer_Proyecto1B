        ...
        <div class="contenedor-principal">
            <div class="tarjeta-pedido">
                ...
                <div class="linea-tiempo d-flex space-around">
                    <div class="paso">
                        <div class="circulo ${pedido.estadoPedido == 'PENDIENTE' ? 'rojo-bg' : 'neutro-bg gris-borde'}">
                            <i class="fas fa-clock ${pedido.estadoPedido == 'PENDIENTE' ? 'blanco-texto' : 'gris-texto'}"></i>
                        </div>
                        <p class="${pedido.estadoPedido == 'PENDIENTE' ? 'rojo-texto texto-negrita' : 'gris-texto'} h7 m-t-1 m-b-0">Pendiente</p>
                    </div>
                    <div class="paso">
                        <div class="circulo ${pedido.estadoPedido == 'EN_PREPARACION' ? 'rojo-bg' : 'neutro-bg gris-borde'}">
                            <i class="fas fa-utensils ${pedido.estadoPedido == 'EN_PREPARACION' ? 'blanco-texto' : 'gris-texto'}"></i>
                        </div>
                        <p class="${pedido.estadoPedido == 'EN_PREPARACION' ? 'rojo-texto texto-negrita' : 'gris-texto'} h7 m-t-1 m-b-0">En Preparación</p>
                    </div>
                    <div class="paso">
                        <div class="circulo ${pedido.estadoPedido == 'LISTO' ? 'verde-bg' : 'neutro-bg gris-borde'}">
                            <i class="fas fa-box ${pedido.estadoPedido == 'LISTO' ? 'blanco-texto' : 'gris-texto'}"></i>
                        </div>
                        <p class="${pedido.estadoPedido == 'LISTO' ? 'verde-texto texto-negrita' : 'gris-texto'} h7 m-t-1 m-b-0">Listo</p>
                    </div>
                </div>
                ...
                <div class="estado-actual amarillo-bg">
                    ...
                    <p class="h7 m-t-0 m-b-0 gris-texto">Tu pedido ha sido recibido y está en cola para preparación</p>
                </div>
                ...
                <c:forEach var="detalle" items="${pedido.detalles}">
                    <div class="detalle-linea d-flex space-between">
                        <p class="gris-texto h6 m-t-0 m-b-1">${detalle.cantidad}x ${detalle.platoMenu.nombre}</p>
                        <p class="gris-texto h6 m-t-0 m-b-1 texto-negrita">$<fmt:formatNumber value="${detalle.subtotal}" pattern="#,##0.00"/></p>
                    </div>
                </c:forEach>
                ...
                <div class="total-linea d-flex space-between">
                    ...
                    <h3 class="rojo-texto texto-negrita m-t-0 m-b-0">$<fmt:formatNumber value="${pedido.totalPedido}" pattern="#,##0.00"/></h3>
                </div>
            </div>
        </div>
    </section>
