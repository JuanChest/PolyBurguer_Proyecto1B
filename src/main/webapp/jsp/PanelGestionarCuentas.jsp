    ...
    <section class="p-4">
        ...
        <div>
            <div class="p-i-2 p-d-2 d-flex space-between align-center">
                <h1 class="h4 texto-normal gris-texto"><i class="fa-solid fa-user-pen"></i> Listado de Cuentas</h1>
				<a href="${pageContext.request.contextPath}/CuentasController?ruta=mostrarFormulario" class="boton boton-l p-i-2 p-d-2 rojo-bg blanco-texto borde-none texto-none centrado">+ Nueva Cuenta</a>            
			</div>
            <hr>
            ...
            <div class="p-4 m-2 blanco-bg borde-redondeado box-shadow">
                <table class="tabla-usuarios m-b-4 ancho-total">
                    <thead>
                        <tr>
                            <th class="h6 gris-texto texto-negrita p-2 texto-izquierda" style="width: 45%;">NOMBRE COMPLETO</th>
                            <th class="h6 gris-texto texto-negrita p-2 texto-centrado" style="width: 30%;">CÉDULA (USUARIO)</th>
                            <th class="h6 gris-texto texto-negrita p-2 texto-centrado" style="width: 25%;">ESTADO</th>
                        </tr>
                    </thead>
                    <tbody>
                        <c:choose>
